                ...
                <div className="flex justify-between items-start">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground mb-2">
                            <span>
                                {new Date(expense.date).toLocaleDateString('es-PE', { weekday: 'short', day: '2-digit', month: '2-digit', year: '2-digit' })}
                                {' '}
                                {new Date(expense.date).toLocaleTimeString('es-PE', { hour: '2-digit', minute: '2-digit' })}
                            </span>
                            {expense.category && (
